document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.getAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = submitButton.getAttribute('data-sending') || 'Sending...';
                    submitButton.disabled = true;
                    
                    setTimeout(function() {
                        submitButton.textContent = submitButton.getAttribute('data-success') || 'Sent!';
    ...
    if (animatedElements.length > 0) {
        ...
        document.addEventListener('transitionend', function(e) {
            if (e.target.classList.contains('visible') && e.propertyName === 'opacity') {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f426595d-922e-45fe-85dd-0dc75b33bfe9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f426595d-922e-45fe-85dd-0dc75b33bfe9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f426595d-922e-45fe-85dd-0dc75b33bfe9';
